  ...
  return (
    <main>
      <Container className={`${styles.page}`}>
        <Title text="Cipresso di San Francesco" level={1} className="text-center mt-2 display-6"/>
        <p className="text-muted text-center fst-italic m-0"> Emilia Romagna, Rimini, Verucchio</p>
        <Row>
          {/* Immagine albero */}
        ...
        <TimeLine startYear={startYear} endYear={currentYear} events={events} />
      </Container>
    </main>
  );
}
